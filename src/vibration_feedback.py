...
* Returns     : NULL
"""
def startup_pulse(gpio_pin):
    device = OutputDevice(gpio_pin)
    i = 0
...
* Parameters  : gpio_pin1 : holds one of the pins the signal is sent too, gpio_pin2 : holds one of the pins the signal is sent too
* Returns     : NULL
"""

def two_vibrator_pulse(gpio_pin1 , gpio_pin2):
...
* Parameters  : gpio_pin1 : holds one of the pins the signal is sent too, gpio_pin2 : holds one of the pins the signal is sent too, gpio_pin3 : holds one of the pins the signal is sent too
* Returns     : NULL
"""

def three_vibrator_pulse(gpio_pin1 , gpio_pin2, gpio_pin3):
    device1 = OutputDevice(gpio_pin1)
    device2 = OutputDevice(gpio_pin2)
